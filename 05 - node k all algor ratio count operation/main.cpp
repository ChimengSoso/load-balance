...
int main(){
    ...
    while (T--) {
        ...
        printf(" 1: \t+ ------------------------------------------------------ +\n");
        printf(" 2: \t|       05 - node k all algor ratio count operation      |\n");
        printf(" 3: \t+ ------------------------------------------------------ +\n 4: \n");
        ...
        int constPoint = rt(n);
        if (constPoint < 0 or constPoint > n-1) {
        ...
        for (int i = 0; i < N_thing; ++i) {
            ...
            insertLoad_jc(constPoint, n);
            insertLoad_kg(constPoint, n);
            insertLoad_nm(constPoint, n);
