...
int main(){
    ...
    while (T--) {
        ...
        printf(" 1: \t+ ------------------------------------------------------ +\n");
        printf(" 2: \t|     06 - good random all algor ratio count operation   |\n");
        printf(" 3: \t+ ------------------------------------------------------ +\n 4: \n");
        ...
        for (int i = 0; i < N_thing; ++i) {
            ...
            insertLoad_jc(idx, n);
            insertLoad_kg(idx, n);
            insertLoad_nm_1(idx, n);
            insertLoad_nm_2(idx, n);
